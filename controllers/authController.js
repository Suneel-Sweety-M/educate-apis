...
const userValidationSchema = Joi.object({
  ...
  role: Joi.string()
    .valid("teacher", "student") // Changed from ['teacher', 'user'] to ['teacher', 'student']
    .default("student")
    .messages({
      "string.valid": "Role must be either 'teacher' or 'student'",
...
const REGISTER = async (req, res, next) => {
  ...
  try {
    ...
    const tempUser = await userModel.create({
      ...
      role: role && ["teacher", "student"].includes(role) ? role : "student", // Changed from 'user' to 'student'
      otp,
